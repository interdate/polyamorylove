...
export class AppComponent implements AfterViewInit {
    ...
    getStatistics() {
        this.api.http.get(this.api.apiUrl + '/statistics', this.api.setHeaders(true)).subscribe((data: any) => {
            ...
            //Footer Menu
            this.menu_items_footer[2].count = statistics.newNotificationsNumber;
            this.menu_items_footer[3].count = statistics.newMessagesNumber;
    ...
    getMessage() {
        if (this.api.username && this.api.username !== 'null' && this.api.username !== 'noname') {
            this.api.http.get(this.api.apiUrl + '/new/messages', this.api.setHeaders(true)).subscribe((data: any) => {
                ...
                this.menu_items_footer[2].count = data.newNotificationsNumber;
                this.menu_items_footer[3].count = data.newMessagesNumber;
